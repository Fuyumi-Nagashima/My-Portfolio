  ...
  <div class="footer__inner inner">
    <div class="footer__wrap">
        ...
        <div class="footer__information">
          <div class="footer__logo">
            <a class="footer__logo-link" href="<?php echo esc_url(home_url('/')); ?>">
              <picture>
                <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/logo-white.webp"
                  type="image/webp">
          ...
          <ul class="footer__sns">
            <li>
              <a href="https://www.facebook.com/login/?locale=ja_JP" target="_blank" rel="noopener noreferrer">
                <picture>
                  <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/facebook-icon.webp"
                    type="image/webp">
            ...
            <li>
              <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">
                <picture>
                  <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/instagram-icon.webp"
                    type="image/webp">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/instagram-icon.png"
                    alt="instagram">
                </picture>
              </a>
            </li>
            <li>
              <a href="https://x.com/home?lang=ja" target="_blank" rel="noopener noreferrer">
                <picture>
                  <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/x-logo.webp"
                    type="image/webp">
      ...
      <div class="footer__map">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12963.333809015348!2d139.69696296798497!3d35.68110269102823!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188cc0a43ae8a3%3A0xfd90ae6c3a216ecd!2z44CSMTUxLTAwNTEg5p2x5Lqs6YO95riL6LC35Yy65Y2D6aeE44Kx6LC3!5e0!3m2!1sja!2sjp!4v1726036307117!5m2!1sja!2sjp"

...
<main>
    ...
    <section class="layout-page-country page-country">
        <div class="page-country__inner inner">
            <div class="page-country__items countries">
                ...
                ?>
                <div class="page-country__item countries__item js-fade" id="<?php echo sanitize_title($country_item['country_name']); ?>">
    ...
    <figure class="countries__image">
        <img src="<?php echo esc_url($image_url); ?>" 
             ...
             width="335" height="251" decoding="async" loading="lazy">
    </figure>
    <?php endif; ?>
</div>
                <?php

      ...
      <section class="layout-sub-mv sub-mv">
        <div class="sub-mv__page-header">
          <h2 class="sub-mv__title">
            <span>terms</span>&nbsp;of&nbsp;<span>service</span>
          </h2>
        </div>
      </section>
    <!-- パンくず -->
  ...
  <section class="layout-terms-of-service terms-of-service sub-page">
    <div class="terms-of-service__inner inner">
      <div class="sub-page__head">
        <h2 class="sub-page__title terms-of-service__title">利用規約</h2>
      </div>
      <div class="terms-of-service__wrapper">
        <p>以下は、Webサイトで使用する一般的な利用規約の例です。</p>
        <ol class="terms-of-service__content">
      ...
      <p class="terms-of-service__text">以上が、当社の利用規約の概要です。お客様のサービス利用にあたっては、本規約をお読みいただき、同意いただける場合のみサービスをご利用ください。</p>
    </div>
  </section>
</main>
<?php get_footer(); ?>